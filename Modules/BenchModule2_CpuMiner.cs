                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (parseMsg == "THREAD")
                                {
                                    ...
                                    int thread = _scoreRun.RunLogicals[Int32.Parse(parseString2)]-1;
                                    App.hwsensors.UpdateSensorLogicalsScore(HWSensorName.CPULogicalsScores, thread, _valscore, _prefix);
                                    parseMsg = "";
                                }
                                if (parseMsg == "END")
                                {
